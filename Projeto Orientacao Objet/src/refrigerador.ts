class Refrigerador {
    ...
    constructor(numPortas: number, volume: number, altura: number, voltagem: number,
                cor: string, tipoTec: string, isInverse: boolean, modelo: string, marca: string,
                tempCongelador: number, tempRefrigerador: number,) {
